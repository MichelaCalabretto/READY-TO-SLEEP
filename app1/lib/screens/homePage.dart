...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Return Container, not Scaffold, since otherwise when I try to open the drawer, the context finds the Scaffold of the homePage instead of the Scaffold of the mainScreen 
    return Container( 
      ...
      child: SafeArea( // SafeArea prevents system UI overlays
        child: Column(
          children: [
            // PreferredSize is a widget that tells its parent the preferred size it wants to be
            // Used because the AppBar doesn't itself have an intrinsic height unless wrapped in a Scaffol
            PreferredSize(
              ...
              child: AppBar(
                ...
                // Use Builder to get proper context for Scaffold.of(context)
                leading: Builder( 
            ...
            // Expanded makes the remaining content take all remaining vertical space
            Expanded(
                ...
                builder: (context, userProfileProvider, _) {
                  ...
                  return Consumer<SleepDataProvider>(
                    builder: (context, sleepDataProvider, _) {
                      // LayoutBuilder makes the layout responsive to screen size
                        ...
                        builder: (context, constraints) {
                          return Column( 
                            children: [
                              ...
                              // Flexible makes it responsive to screen height
                              Flexible( 
                              ...
                              // Spacer between the greeting and the chart
                              const SizedBox(height: 8), 

                              // ChartSwitcher
                              // Flexible makes the chart section flexible without risking overflow
                              Flexible( 
